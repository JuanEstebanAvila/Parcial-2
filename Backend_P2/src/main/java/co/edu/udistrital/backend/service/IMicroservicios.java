...
public interface IMicroservicios {
    ...
    List<ResponseDTO> getTriatletasGenero(String genero);
    //Devuelve lso atletas que esten en una categoría en particular
    List<ResponseDTO> getTriatletasCategoria(String categoria);
    //Devuelve los atletas que esten dentro de una Especialidad en particular 
    List<ResponseDTO> getTriatletasEspecialidad(String especialidad);
    //Devuelve los atletas que esten en la modalidad Cross
    List<ResponseDTO> getTriatletasCross(boolean modalidadCross);
    //Borra un Atleta
